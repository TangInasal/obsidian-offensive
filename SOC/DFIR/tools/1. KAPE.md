...
![[Pasted image 20260606194922.png]]

#### Command Line
```kape
.\kape.exe --tdest C:\Users\Diox\Desktop --tflush --target !BasicCollection,!SANS_Triage,KapeTriage --zip CaseName --mflush --module !EZParser --mef csv --gui
```
